...
Generated from API version: 0.1.12
...
class CleanerOptionsInput(BaseModel):
    ...
    base_url: str | None = Field(
        None, description="Base URL for resolving relative links (readability)"
    )
    ...
    output: Literal["html", "text"] = Field(
        "html", description="Output format for trafilatura/readability"
    )
