...
class AnalysisResultInput(BaseModel):
    ...
    suggested_schema: Any | None = Field(
        None, description="Schema (JSON object or YAML string)"
    )
...
class AnalysisResultOutput(BaseModel):
    ...
    suggested_schema: Any = Field(..., description="Schema suggestion (JSON object)")
